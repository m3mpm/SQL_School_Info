...
Анализ и статистика данных по Школе и ученикам в школе

Необходимо создать базу данных имитирующую Школу: ученики, задания, проверки. Написать процедуры и функции для получения информации, а также процедуры и триггеры для её изменения.

## Логическое представление базы данных

![SQL-School-Info](./images/database-model.png)
...
*Все задания должны быть названы в формате A5_memory. \
В дальнейшем принадлежность к блоку будет определяться по содержанию в названии задания названия блока, например "CPP3_SmartCalc_v2.0" принадлежит блоку CPP, то есть С++. \*

### Задание 2. Изменение данных
